...
pub fn Home() -> impl IntoView {
    view! {
        <section class="container flex-1 flex flex-col gap-10">
            <div class="flex flex-col w-full gap-10 items-center text-center lg:text-start pt-20">
                ...
                >
                    Say farewell to complex state management and tangled async code. Embrace Leptos
                    {"Query's"}
                    sleek, declarative approach for effortless data fetching and state sync, uplifting developers and users alike.
                </span>
            </div>
            ...
            <div class="flex flex-col lg:flex-row items-stretch gap-8 p-8 max-w-[1200px] mx-auto lg:min-h-72">
                ...
                <InfoCard title="Developer First">
                    <div class="h-full flex flex-col justify-between items-start">
                        <p>
                            Designed with developers in mind, Leptos Query includes comprehensive devtools and simplifies async state to directly improve
                            <strong>developer & user experiences</strong>
                        </p>
